...
- Expand you solution so that it can handle inputs containing multiple solutions. Your function should return a set of tuples sorted in ascending order, where each tuple is a solution.
